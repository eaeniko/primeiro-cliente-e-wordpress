...
?>
	...
	$theme = wp_get_theme();
	$site_credits = sprintf( __( '<span class="credits-copyright">&copy; %1$s %2$s. </span><span class="credits-theme"><a href="https://www.linkedin.com/in/nikolaitti/" target="_blank">Nikolai C</a>.</span>', '' ), 
		date ( 'Y' ),
